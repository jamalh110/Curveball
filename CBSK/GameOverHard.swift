...
class GameOverHard: SKScene {
    ...
    let gameOverNode = SKSpriteNode(imageNamed: "GameOverLabel")
    
    let gemsNode = SKLabelNode(text: String(variables.gems))
    let gemSprite = SKSpriteNode(imageNamed: "GemOpaque")
    let highScoreLabel = SKLabelNode(text: "Highscore: " + String(variables.highScoreHard))
    ...
    override func didMove(to view: SKView) {
        ...
        highScoreLabel.text = "Highscore: " + String(variables.highScore)
        ...
        retryButtonPushed = SKSpriteNode(imageNamed:"RetryButtonPushed")
